...
export const APPVERSION : string = "1.0.4";
...
export const COMMANDE_SPECIALISEE_URL = SERVER_URL + '/commandeSpecialisee';
...
export const COMMANDE_SPECIALISEE_PRESTATAIRE_URL = COMMANDE_SPECIALISEE_URL + '/prestataire';
